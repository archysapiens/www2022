...
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP in('06', '07','42','55') and PTAANT in ('00','CG','AG')) as Sueldo,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=2 and  CONCEP in('01','02','04') and PTAANT in ('52','SI','SR','SP','SS')) as dEDUCCIONES,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP in('32','A1','A2','A3','A4','A5') and PTAANT in ('00','PD','PV','VD')) as PRIMA,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP in('68','69','75') and PTAANT in ('TR','AN','AP','EA')) as Estimulos,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP ='24' and PTAANT='GA') as PeriodicidadEstimulo,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP in('37','45','57') and PTAANT in ('TP','AL','LM') ) as ApoyoEconomico,
(select sum(importe) from btac2015 where llave=b.llave and  tconcep=1 and  CONCEP in('59','73') and PTAANT in ('DT','DR','DM') ) as PrestacionesEconomicas
from bdac2015 b
where b.partida ='11301' and b.INDMANDO not in ('90','80') and b.tipnom IN ('11','6L')  
and b.QNAPROC='24' and b.tipotrab!='20') ssa
group by rfc, serpub,cr,ur,puesto,denopuesto,denocargo,nombre,nivelpuesto,qnaproc,indmando,tipotrab,areaads
";

$GestorArchivo = fopen("bdac2015.txt", "w");
if (!$GestorArchivo) {
