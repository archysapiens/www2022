-- Se agregan campos para las percepciones y codigo de puesto

drop table EMPL_ART_74;
create table EMPL_ART_74 AS select  bd.rfc, bd.estado, bd.puesto,bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV, sum(bd.per) as per
from BDART742013 bd
...
GROUP BY bd.rfc, bd.estado, bd.puesto, bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV
union all
select  bd.rfc, bd.estado, bd.puesto,bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV, sum(bd.per) as per
from BDART742014 bd
...
create table EMPL_ART_74_CMPLTO AS select  bd.rfc, bd.estado, bd.puesto,bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV, sum(bd.per) as per
...
create table EMPL_ART_74_416 AS select  bd.rfc,bd.estado, bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV,sum(bd.per) as per
...
GROUP BY bd.rfc, bd.estado, bd.puesto, bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV
union all
select  bd.rfc,bd.estado, bd.ur,bd.CURP, bd.NOMBRE, bd.qnaenvio,bd.ANIOENV,sum(bd.per) as per
