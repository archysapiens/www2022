...
foreach ($Trimestres as $Trim) { 
		...
		(select sum(importe) from btac$Anio where llave=b.llave and  tconcep=2 and  CONCEP in('01','02','04') and PTAANT in ('52','SI','SR','SP','SS')) as dEDUCCIONES,
		...
		and b.QNAPROC='$Trim' and b.tipotrab!='20') ssa
		where ur >='100' and ur <='700'
		...
		// Tabla 10181
		         ...
		         $objPHPExcel->setActiveSheetIndex(SEIS)   
		          ...
		          ->setCellValue('D'.($Contador-4), 'Mensual');
		...
		$objWriter->save($Anio."_".$Trim."_"."Central"."_VIII_Remuneraciones Brutas y Netas.xlsx");
