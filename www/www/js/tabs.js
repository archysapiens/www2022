...
function msgUser() {
	...
	toastr.error('<a href="/ssa/ptfma_recuperar_pwd.php" role="button" class="btn btn-large btn-danger pull-left\">Recuperar Contraseña</a>', '<h4>Ya existe el Usuario</h4>');
}