...
/**	
		$sql="SELECT cu.unidades_id,cu.nombre_unidad, cu.descripcion, pv.plazavacante_id
		FROM plazasvacantes_xa pv ,CtUnidades cu
		WHERE pv.unidades_id=cu.unidades_id and( 
		cu.nombre_unidad  LIKE :Patron OR 
		cu.descripcion LIKE :Patron) AND PV.CONVOCATORIA IS NULL
