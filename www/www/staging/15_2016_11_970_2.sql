set @fecha_evento='20160523184606';
set @id_remesas=970;
set @archivo_procesado='../staging/20160523184606BT161508.txt.err';
set @IdDir =1;
set @Estatus='E';
set @Evidencia='Evidencia';
load data local infile '../staging/20160523184606BT161508.txt.err'
INTO TABLE bitacora
