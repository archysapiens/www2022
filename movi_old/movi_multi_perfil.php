...
$CatMovimiento="#";
$SeleccionPerfiles="";
$ArrPerfiles =array( "1"  => " Data Tracing Automation Management     " ,       
                     "2"  => " Data Tracing Regulator " ,            
                     "3"  => " Data Sets and Lineage Management" ,   
...
foreach ($ArrPerfilesPorUsuario as $item) {
   ...
   if( $ContadorPrivilegios > CERO){
       ...
       if($item=="1"){
            $Msg= "Gestión de ejercicios de Data Tracing que incluye automatización de validaciones de Linaje y reportes regulatorios, además de validación de reportes regulatorios y LTP's";
            $DataClass ="medical";
            $Ico ="corporate-researcher-icon";
            $CatMovimiento="movi/movi_escritorio_ura.php?tipo=mp&origen=m";
			//$CatMovimiento="movi_escritorio.php?tipo=mp&origen=m";
       }     
       elseif($item=="2") {
            $Msg= "Revisión, Validación y Certificacion de evidencias y conclucsiones de los ejercicios de Data Tracing sobre los diversos productos y reportes regulatorios.";
        ...
        elseif($item=="3") {
            $Msg= "Administracion de conexion y extracciones de estructuras de linaje y metadata desde proveedores en sistemas diversos.";
               $Ico ="corporate-researcher-icon";
            $DataClass ="company";   
...
<body style="height: 110%;
    ...
    background-image: linear-gradient(rgb(253, 253, 253 ), rgb(252, 252, 25 ));
    background-color: #fFfFfF;" id="yui_3_14_1_1_1489447304922_76">
<div id="page-container" style=" background-repeat: no-repeat;
    background-image: linear-gradient(rgba(55, 63, 155,.07),rgba(228, 228, 240,2));
...
<img src="images/citi2.jfif" width="256" height="125" style="margin-left:100px;" />

<div style="margin-left: auto;
    margin-right: auto;
    position: relative;width: 982px;top:-60;" class="logged-out-header-support">

<div id="content" class="" style="margin-top: 1px;">
...
<div id="rgw1_58c729ac9df67" class="signup-researcher-classification js-widgetContainer">  
<div id="rgw2_58c729ac9df67" class="su-researcher-classification js-widgetContainer"> 
<noscript> &lt;div class="c-box-warning full-width-element" style="text-align: center; margin: 0;"&gt; &lt;div style="margin: auto; padding:10px;" class="container"&gt; For full functionality of ResearchGate it is necessary to enable JavaScript. Here are the &lt;a href="http://www.enable-javascript.com/" rel="nofollow noreferrer noopener" target="_blank" style="color: #444; text-decoration: underline;"&gt; instructions how to enable JavaScript in your web browser&lt;/a&gt;. &lt;/div&gt; &lt;/div&gt; </noscript> 
<div class="signup-wrapper"> 
<div class="c-col-content"> 
<div class="c-content js-step-rendering"> 

   <div class="headline">  
    <h1 class="counts"> 
        <span class="headline-part">DATA TRACING AUTOMATION SYSTEM </span> 
        <span class="headline-part"> </span> </h1>  
...
?>
            ...
            <div style="border-top: 1px solid #dedede; border-bottom: 1px solid #dedede; font-family: 'Times New Roman', serif; font-size: 14px; color: #666666; text-align: center; padding: 14px 0px;">EL BANCO NACIONAL DE MEXICO</a></div>
            ...
            <div style="margin: 32px auto 42px auto; text-align: center; font-family: 'Times New Roman', serif; font-weight: lighter; font-size: 13px;">
                <p style="color: #808080; line-height: 5px;">Copyright 2022 © Los productos y ofertas de Citibanamex están dirigidos sólo a residentes de México</p> 
                <p style="color: #808080; line-height: 5px;">Ciudad de México CP. 11410 </p>
            </div>
