...
<!--		
			<link rel="canonical" href= "https://www.banamex.com" >
		<link rel="alternate" href= "https://www.banamex.com" hreflang="es">
			
			<link rel="stylesheet" media="none" onload="this.media='all'" crossorigin="anonymous" href="https://www.banamex.com/assets/globals/css/components/citiFooter.css">
		
			
				<script src="https://www.banamex.com/assets/globals/js/citi-libraries/citi-global-site.js"></script>
		

		<link rel="preload stylesheet" as="style" href="https://www.banamex.com/assets/globals/css/citi-globals.css">

		<link rel="preload stylesheet" as="style" href="https://www.banamex.com/assets/globals/css/components/citiNavbar_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" crossorigin="anonymous" href="https://www.banamex.com/assets/globals/css/components/citiFooter.css">
		<link rel="preload stylesheet" as="style" href="https://www.banamex.com/assets/globals/css/components/citiActionbutton.css">
	
	
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiHero.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiHeroBanner.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiCollapse_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiTabs_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiCard.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiBackToTop_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiLoader.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiButton.css">
		<link rel="preload stylesheet" as="style" href="https://www.banamex.com/assets/globals/css/components/citiCarrousel_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiCurrency_js.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiTogglebutton.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiTextfield.css">
		<link rel="stylesheet" media="none" onload="this.media='all'" href="https://www.banamex.com/assets/globals/css/components/citiLoader.css">
		-->			
	</head>
	<body>
<style>
				#body2{	
					background-image: linear-gradient(to bottom, rgba(5,109,174 , 0.33) 0%,rgba(5,109,174, 0.22) 100%), url("saludLogo.jpg");
					width:1350px;
					height:700px;
					opacity:0.1;
					position:absolute;
				...
				@media(min-width: 990px) {
					...
					background-image: linear-gradient(rgba(221,226,229,.02),rgba(5,109,174,1) ) !important; 
...
-->
				 ...
				 <td width="683" align="right">
						 <div class="col-lg-12">
								<h2>Data Tracing Automation System</h2>
					</div>
				 </td>    
			  </tr>
			</tbody></table>
					...
					<section id="formHolder" class="hidden-xs hidden-sm">
						<div class="row">
							...
							<div class="col-sm-6 brand">
								...
								<div class="heading">
									<img src="./images/citi.jpg" id="Banco Nacional de México" width="447px" height="290px"/>
				...
				<div id="footerEPN" style="clear:both; margin-top: 12px;">
					  <div style="clear: both; width: 100%; border-top: 1px solid #07166C; margin-bottom: 1px;"></div>
					<div style="color: #FEFEFE; border-top: 1px solid #07166C; border-bottom: 1px solid #07166C; font-family: 'Times New Roman', serif; font-size: 14px; color: #FEFEFE; text-align: center; padding: 14px 0px;">EL BANCO NACIONAL DE MEXICO  </div>
					<div style="clear: both; width: 100%; border-top: 1px solid #07166C; margin-top: 1px;"></div>
					...
					<div style="margin: 32px auto 42px auto; text-align: center; font-family: 'Times New Roman', serif; font-weight: lighter; font-size: 14px;">
					  <p style="color: #FEFEFE; line-height: 5px;">Copyright 2022 © Los productos y ofertas de Citibanamex están dirigidos sólo a residentes de México</p>
					  <p style="color: #FEFEFE; line-height: 5px;">Ciudad de México CP. 11410</p>
					</div>
